...
def detect_excel_relationships(state: AgentState):
    extracted = state.get("extracted_data")
    if not extracted:
        return {"detected_relations": None}
    ...
    return {"detected_relations": relations}


def print_detected_relationships(state: AgentState):
